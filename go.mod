...
require (
	...
	github.com/huaweicloud/huaweicloud-sdk-go-v3 v0.1.214 // indirect
...
replace go.podman.io/buildah => go.podman.io/buildah v1.45.0

replace github.com/opencontainers/runc => github.com/opencontainers/runc v1.3.4
