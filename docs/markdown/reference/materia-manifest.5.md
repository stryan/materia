...
Static = false # Indicates whether the systemd service not generated by a Quadlet and thus can be enabled/disabled. Usually used for .timer files
Disabled = false # If true, make sure static unit is disabled
